...
function readData() {
	    ...
	    var astring = document.mainform.acoef.value;
            ...
            if(isNaN(a)){alert("Enter a number for coefficient a");}
            if(isNaN(hco)){alert("Enter a number for coefficient h");}
            if(isNaN(kco)){alert("Enter a number for coefficient k");}

            if(a==0){alert("Coefficient a cannot be zero");}
